   ...
   if($row['usertype']=='admin')
{
 ...
 echo '<script>alert(" nom utilisateur ou bien le mot de pass est inncoracet");
...
<div class="topbutton">
    ...
    <form action="login.php" method="POST">
        ...
        <span >Nom utilisateur:*</span><br>
        <input type="text"name ="username" required   placeholder="Taper votre nom "  >
     <span >Mot de passe:*</span><br>
        <input type="password"name ="password" placeholder="Taper votre mot de passe " required  >
    
    <input type="submit" value="connexion" name ="connexion" class="btn_inscr" required>
