...
if(isset($_POST['update_product'])){
   ...
   if(empty($product_name) || empty($product_price) || empty($product_image)){
      ...
      $update_data = "UPDATE products SET name='$product_name', price='$product_price', image='$product_image' 
       WHERE id = '$id'";
...
<div class="admin-product-form-container centered">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      <h3 class="title">Mettre a jour le produit </h3> <br>
     ...
     <span> Le Prix :*</span>
      ...
      <a href="admin_page.php" class="btn">Retourner</a>
   </form>
